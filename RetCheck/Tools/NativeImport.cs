...
namespace RetCheck.Tools
{
    public class NativeImport
    {
        ...
        public static extern bool VirtualProtect(IntPtr lpAddress, UIntPtr dwSize, NativeStructs.MemoryProtection flNewProtect, out NativeStructs.MemoryProtection lpflOldProtect);
